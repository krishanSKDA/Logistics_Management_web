...
<?php endif; ?>
                ...
                <a href="<?php echo e(route('register')); ?>" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ms-auto">
                    <?php echo e(__("Don't have an account? Register")); ?>
...
<?php endif; ?>
<?php /**PATH D:\SSP_Website_Sem02\Logistics_Management - Testing\Logistics_website\resources\views/auth/login.blade.php ENDPATH**/ ?>