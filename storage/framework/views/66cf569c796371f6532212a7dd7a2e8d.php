      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <!-- Cards: Summary or stats displayed in card format -->
            <?php echo $__env->make('Userpanel.card', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

           
            <!-- Charts: Shows graphical data representations -->
            <?php echo $__env->make('Userpanel.chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          </div>
        </main>
      </div>
    </div>
...
<?php /**PATH D:\SSP_Website_Sem02\Logistics_Management - Testing\Logistics_website\resources\views/components/layout/app.blade.php ENDPATH**/ ?>